...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/tjYiGvfPB/model.json',modelLoaded);
...
function gotResult(error, results){
    if(error)
    {
        ...
        if(results[0].label == "This is lo0oking amazing"){
        ...
        if(results[1].label == "This is lo0oking amazing"){
